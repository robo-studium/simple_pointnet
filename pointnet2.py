...
class PointNetFeaturePropagation(nn.Module):
    ...
    def forward(self, xyz1, xyz2, points1, points2):
        ...
        points1: (B, N, C1) - target features
...
class PointNet2(nn.Module):
    def __init__(self, in_dim=5, num_classes=2):
        """
        ...
        self.fp1 = PointNetFeaturePropagation(
            in_channel=128 + in_dim, mlp=[128, 128, 128]
        )
    ...
    def forward(self, x):
        ...
        xyz = x[:, :, :3]  # (B, N, 3)
        features = x  # (B, N, 5) - use all features including xyz
