...
class PointNetFeaturePropagation(nn.Module):
    ...
    def forward(self, xyz1, xyz2, points1, points2):
        ...
        if S == 1:
            ...
            interpolated_points = torch.sum(indexed * weight.view(B, N, 3, 1), dim=2)  # (B, N, C2)
...
class PointNet2(nn.Module):
    def __init__(self, in_dim=5, num_classes=2, num_points=32768):
        ...
        self.sa1 = PointNetSetAbstraction(
            npoint=npoint1, radius=0.5, nsample=16,
            in_channel=in_dim + 3, mlp=[32, 32, 64], group_all=False
        )
        self.sa2 = PointNetSetAbstraction(
            npoint=npoint2, radius=1.0, nsample=16,
