...
class UNetDenoiser(nn.Module):
    """
    U-Net architecture for LiDAR point cloud denoising
    ...
    def __init__(self, in_channels=5, num_classes=2, base_channels=64, bilinear=False):
...
if __name__ == "__main__":
    model = UNetDenoiser(in_channels=5, num_classes=2, base_channels=64, bilinear=False)
